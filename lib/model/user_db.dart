...
class Users {
  ...
  String email = "north_korea_no1@gmail.com";
...
// コンストラクタ
  Users(this.name, this.age, this.gender, this.pics, this.email, this.introduce,
      this.likes, this.service);

// 呼び出しMethod
  Users userCall() {
    return Users(name, age, gender, pics, email, introduce, likes, service);
